...
| **Gest Linux Pro** | GTK system toolkit | 2.2.8 | — (Flatpak only) | [Gest_Linux_Pro](https://github.com/Mr-Aurevo-X/Gest_Linux_Pro/releases/tag/v2.2.2) |
| **UtilKit** | local toolkit (search, hash, PDF, disk map) | 2.2.8 | — (Flatpak only) | [UtilKit](https://github.com/Mr-Aurevo-X/UtilKit/releases/tag/MrAurevoX-Kit-v2.2.8) |

...
| **MrAurevoX Kit** | local toolkit (search, hash, PDF, disk map) | 2.0.1 | [linux-releases](https://github.com/Mr-Aurevo-X/linux-releases/releases/tag/MrAurevoX-Kit-v2.0.1) | [linux-flatpak-releases](https://github.com/Mr-Aurevo-X/linux-flatpak-releases/releases/tag/MrAurevoX-Kit-v2.0.1) |

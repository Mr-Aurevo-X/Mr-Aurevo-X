...
<!-- Cards are static SVGs regenerated by Actions (private-capable when STATS_GH_TOKEN is set). -->
<!-- Aggregates only — no private repo names/contents. No top-langs (would leak private stack mix). -->

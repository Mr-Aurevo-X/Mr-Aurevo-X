...
| Outil | Role | Lien |
|:--|:--|:--|
| **QrTools** | QR Simple + Lot (QrMake + QrBatch · v1.2.4 · Filament) | [repo](https://github.com/Mr-Aurevo-X/QrTools) / [releases](https://github.com/Mr-Aurevo-X/QrTools/releases/latest) |
| **UnitConvert** | Unités + Devises (v1.3.4 · Filament) | [repo](https://github.com/Mr-Aurevo-X/UnitConvert) / [releases](https://github.com/Mr-Aurevo-X/UnitConvert/releases/latest) |
| **TimeTools** | Horodatage · chrono · minuteries · Pomodoro (v1.2.4 · Filament) | [repo](https://github.com/Mr-Aurevo-X/TimeTools) / [releases](https://github.com/Mr-Aurevo-X/TimeTools/releases/latest) |
| **PixClean** | Strip EXIF/GPS/XMP (ex-MetaStrip · v1.4.4 · Filament) | [repo](https://github.com/Mr-Aurevo-X/PixClean) / [releases](https://github.com/Mr-Aurevo-X/PixClean/releases/latest) |

...
| **UtilKit** | local toolkit (search, hash, PDF, disk map) | 2.2.6 | — (Flatpak only) | [UtilKit](https://github.com/Mr-Aurevo-X/UtilKit/releases/tag/MrAurevoX-Kit-v2.2.6) |
